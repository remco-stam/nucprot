...
Rep8_1 <- df8$proteinGroups.nucl.LFQ.intensity.8hrsI.Rep1/df8$proteinGroups.nucl.LFQ.intensity.8hrsNI.Rep1
Rep8_2 <- df8$proteinGroups.nucl.LFQ.intensity.8hrsI.Rep2/df8$proteinGroups.nucl.LFQ.intensity.8hrsNI.Rep2
Rep8_3 <- df8$proteinGroups.nucl.LFQ.intensity.8hrsI.Rep3/df8$proteinGroups.nucl.LFQ.intensity.8hrsNI.Rep3
...
Rep24_1 <- df24$proteinGroups.nucl.LFQ.intensity.24hrsI.Rep1/df24$proteinGroups.nucl.LFQ.intensity.24hrsNI.Rep1
Rep24_2 <- df24$proteinGroups.nucl.LFQ.intensity.24hrsI.Rep2/df24$proteinGroups.nucl.LFQ.intensity.24hrsNI.Rep2
Rep24_3 <- df24$proteinGroups.nucl.LFQ.intensity.24hrsI.Rep3/df24$proteinGroups.nucl.LFQ.intensity.24hrsNI.Rep3
...
# Write tables
write.table(df8.poi, "Step8_eightUP.txt", quote = FALSE, sep = "\t", row.names = TRUE)
write.table(df8.poiD, "Step8_eightDOWN.txt", quote = FALSE, sep = "\t", row.names = TRUE)
write.table(df24.poi, "Step8_twfrUP.txt", quote = FALSE, sep = "\t", row.names = TRUE)
write.table(df24.poiD, "Step8_twfrDOWN.txt", quote = FALSE, sep = "\t", row.names = TRUE)
