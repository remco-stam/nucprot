...
#Write tables
write.table(eightDOWN, "Step9_eightDOWN.txt", quote = FALSE, sep = "\t")
write.table(eightUP, "Step9_eightUP.txt", quote = FALSE, sep = "\t")
write.table(twfrDOWN, "Step9_twfrDOWN.txt", quote = FALSE, sep = "\t")
write.table(twfrUP, "Step9_twfrUP.txt", quote = FALSE, sep = "\t")
